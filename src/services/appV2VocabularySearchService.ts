...
export type AppV2DeckSourceType =
	| "foundation"
	| "collected"
	| "sent"
	| "alphabet";
...
export async function searchAppV2VocabularyBank(
	query: string,
	limit = 100,
	sourceTypes?: AppV2DeckSourceType[],
	offset = 0,
...
> {
	try {
		...
		const fallbackResult = await searchAppV2VocabularyBank("", 80, [
			"collected",
		]);
