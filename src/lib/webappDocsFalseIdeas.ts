...
const getWebappDocsFalseIdeasContent = (locale: AppLocale = "fr"): string =>
	locale === "en"
		? WEBAPP_DOCS_FALSE_IDEAS_EN_CONTENT
		: WEBAPP_DOCS_FALSE_IDEAS_CONTENT;

const getWebappDocsFalseIdeasNavArticles = (
	locale: AppLocale = "fr",
): readonly WebappDocsFalseIdeasNavArticle[] =>
	locale === "en"
		? WEBAPP_DOCS_FALSE_IDEAS_EN_NAV_ARTICLES
		: WEBAPP_DOCS_FALSE_IDEAS_NAV_ARTICLES;

const getWebappDocsFalseIdeasSlug = (locale: AppLocale = "fr"): string =>
	locale === "en" ? WEBAPP_DOCS_FALSE_IDEAS_EN_SLUG : WEBAPP_DOCS_FALSE_IDEAS_SLUG;

const getWebappDocsFalseIdeasSubtitle = (locale: AppLocale = "fr"): string =>
	locale === "en"
		? WEBAPP_DOCS_FALSE_IDEAS_EN_SUBTITLE
		: WEBAPP_DOCS_FALSE_IDEAS_SUBTITLE;

const getWebappDocsFalseIdeasTitle = (locale: AppLocale = "fr"): string =>
	locale === "en" ? WEBAPP_DOCS_FALSE_IDEAS_EN_TITLE : WEBAPP_DOCS_FALSE_IDEAS_TITLE;

export {
	getWebappDocsFalseIdeasContent,
	getWebappDocsFalseIdeasNavArticles,
	getWebappDocsFalseIdeasSlug,
	getWebappDocsFalseIdeasSubtitle,
	getWebappDocsFalseIdeasTitle,
};
