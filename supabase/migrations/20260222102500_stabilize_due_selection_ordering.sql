-- =====================================================
-- Stabilize due selection ordering for deterministic pagination
-- Date: 2026-02-22
-- Purpose:
--   1) Add explicit tie-breakers when seeding Foundation candidates
--   2) Add explicit tie-breakers in due-card ORDER BY
-- =====================================================
...
BEGIN
  ...
  ORDER BY
    ...
    CASE WHEN ucs.foundation_card_id IS NOT NULL THEN 0 ELSE 1 END ASC,
    coalesce(ucs.source_type::text, '') ASC,
    ucs.status ASC,
    ucs.foundation_card_id ASC NULLS LAST,
