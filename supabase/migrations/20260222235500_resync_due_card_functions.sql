-- =====================================================
-- Re-sync due-card RPC definitions on remote project
-- Date: 2026-02-22
-- Purpose:
--   Ensure get_due_cards_v2/get_due_count_v2 match repository definitions.
--   This corrects older deployed definitions that still referenced
--   profiles.scheduler_timezone and fail on projects without that column.
-- =====================================================
